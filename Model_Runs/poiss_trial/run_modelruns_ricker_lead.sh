...
config=Model_Runs/poiss_trial/RickerConfigLead.txt
...
Rscript Model_Runs/poiss_trial/modelruns_ricker_lead.R ${datFile} ${parFile} ${clsize} ${saveFile} ${index1} ${index2} > Model_Runs/poiss_trial/outputRickerLead_${oldName}.txt
