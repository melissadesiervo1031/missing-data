...
config=Model_Runs/poiss_trial/RickerConfigLag.txt
...
Rscript Model_Runs/poiss_trial/modelruns_ricker_lag.R ${datFile} ${parFile} ${clsize} ${saveFile} ${index1} ${index2} > Model_Runs/poiss_trial/outputRickerLag_${oldName}.txt
