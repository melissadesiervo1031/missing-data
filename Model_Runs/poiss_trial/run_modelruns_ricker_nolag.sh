...
config=Model_Runs/poiss_trial/RickerConfigTrial.txt
...
Rscript Model_Runs/poiss_trial/modelruns_ricker_nolag.R ${datFile} ${parFile} ${clsize} ${saveFile} ${index1} ${index2} > Model_Runs/poiss_trial/outputRickerNolag_${oldName}.txt
