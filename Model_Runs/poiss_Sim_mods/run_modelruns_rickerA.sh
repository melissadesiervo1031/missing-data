...
Rscript Model_Runs/poiss_Sim_mods/modelruns_ricker.R ${datFile} ${parFile} ${clsize} ${saveFile} ${index1} ${index2} > Model_Runs/poiss_Sim_mods/outputRickerA_${oldName}.txt
