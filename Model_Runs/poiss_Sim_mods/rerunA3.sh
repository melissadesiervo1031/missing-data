...
Rscript Model_Runs/poiss_Sim_mods/modelruns_ricker.R data/missingDatasets/pois_sim_randMiss_A.rds data/missingDatasets/pois_sim_params.rds 5 Model_Runs/RickerA_randMiss_resultTable3.rds 5001 7500 > Model_Runs/poiss_Sim_mods/outputRickerB_randMiss3.txt
