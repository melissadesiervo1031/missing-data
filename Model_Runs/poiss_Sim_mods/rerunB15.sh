...
Rscript Model_Runs/poiss_Sim_mods/modelruns_ricker.R data/missingDatasets/pois_sim_randMiss_B.rds data/missingDatasets/pois_sim_params.rds 5 Model_Runs/RickerB_randMiss_resultTable15.rds 35001 37500 > Model_Runs/poiss_Sim_mods/outputRickerB_randMiss15.txt
