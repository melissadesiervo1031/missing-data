...
$$
GPP=\beta_0+phi\times GPP_{t-1}+\beta_1\times X_{light}+\epsilon
$$
...
``` {r , echo=FALSE, fig.cap="Figure caption: Two sites with low missing data from Appling et al. Data points represent the estimate and the error bars are the 95% credible interval. The line is modeled light using Yard et al. 1995 (NOTE: Light is scaled to fit on the graph) ", fig.show="hold", out.width="50%"}
...
```{r bayes-param-compare, echo=FALSE, fig.cap="Figure X: Parameter estimates from Bayesian missing-data model. (A)= all data, (B)= positive data ", fig.show="hold", out.width="50%"}

#setwd("C:/Users/matt/IDrive-Sync/Postdoc/Estimating missing data/daily_predictions")
fit_summary_bayes <- readRDS("summary_bayes_lowmiss1.RDS")
known.data<- readRDS("known_data_bayes_lowmiss1.RDS")
...
```{r , echo=FALSE, fig.cap="Figure X: Parameter estimates from Bayesian missing-data model. (A)= all data, (B)= positive data ", fig.show="hold", out.width="50%"}
#setwd("C:/Users/matt/IDrive-Sync/Postdoc/Estimating missing data/daily_predictions")
fit.miss<- readRDS("full_amelia_lowmiss1.RDS")
fit_summary_amelia <- readRDS("summary_amelia_lowmiss1.RDS")
known.data<- readRDS("known_data_amelia_lowmiss1.RDS")
...
### Bayes estimated data-low miss 1
```{r,echo=FALSE,fig.cap="Figure X: Estimated missing data with 95% CI. (A)=scatter plot of observed vs. expected. (B)= time-series of estimated data overlapping known data.", fig.show="hold", out.width="50%" }
#setwd("C:/Users/matt/IDrive-Sync/Postdoc/Estimating missing data/daily_predictions")
##Force some missing data-BY WEEK##
#Note-the model will still work if no data is missing but the objects in the next block of code (i.e., "y_index_mis", etc.)
#still need to be created
...
fit.miss<- readRDS("full_bayes_lowmiss1.RDS")
...
```
### Amelia estimated data-low miss 1
```{r echo=FALSE,echo=FALSE,results='hide',fig.keep='all', fig.cap="Figure X: Estimated missing data with 95% CI. (A)=scatter plot of observed vs. expected. (B)= time-series of estimated data overlapping known data.", fig.show="hold", message=TRUE, out.width="50%"}
#setwd("C:/Users/matt/IDrive-Sync/Postdoc/Estimating missing data/daily_predictions")
...
fit_summary_bayes <- readRDS("summary_bayes_lowmiss2.RDS")
known.data<- readRDS("known_data_bayes_lowmiss2.RDS")
...
fit_summary_amelia <- readRDS("summary_amelia_lowmiss2.RDS")
known.data<- readRDS("known_data_amelia_lowmiss2.RDS")
