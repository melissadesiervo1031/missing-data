...
# Randomly select 1 of the 1000 simulations
sample(1:1000, 1)  #907

# clip data to this simulation #
figDat_clip <- figDat_temp %>%
  filter(simName == 907)

#within the 1 simulation, select one model run (same autocorr and missingness) then Compare to the true parameter
...
## save results
png(file = "./figures/parameterRecovery_sim_Gaussian_medsSD_trimmed.png", width = 9, height = 4, units = "in", res = 700)
...
## save results
png(file = "./figures/parameterRecovery_sim_Gaussian_medsSD.png", width = 9, height = 4, units = "in", res = 700)
Gauss_paramRecov
dev.off()
# 
# 
